...
onMounted(() => {
  ...
  monaco.languages.register({
    id: "yaml1",
    aliases: ["YAML", "yaml", "YML", "yml", "yaml1"],
...
### https://gitee.com/getcharzp/gin-gorm-oj/blob/master/vue/src/page/question/editor.vue

### https://segmentfault.com/a/1190000042292716

### https://dream2023.gitee.io/monaco-editor/api/interfaces/monaco.editor.istandaloneeditorconstructionoptions.html
